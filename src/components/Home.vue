<template>
  <div class="page">
    <header class="page-header">
      ...
      <nav class="nav">
        <a @click="toggleLogin">登录</a>
        <template v-if="showLoginOptions">
          <a @click="goToAssets">我的资产</a>
          <a>社群建设</a>
          <a>邀请排行</a>
          <a>复制地址</a>
          <a>断开链接</a>
...
/* Styles for the main Home component */
  ...
  .page-header {
    ...
    padding: 1rem;
    z-index: 100;
    gap: 1rem; /* Add gap between logo and nav */
  }
